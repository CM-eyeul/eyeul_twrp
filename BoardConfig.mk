...
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x00008000 --ramdisk_offset 0x02008000 --dt device/htc/eyeul/recovery/kernel/dt.img --tags_offset 0x01e00000
BOARD_CUSTOM_BOOTIMG_MK := device/htc/eyeul/recovery/kernel/mkbootimg.mk
...
TARGET_PREBUILT_KERNEL := device/htc/eyeul/recovery/kernel/kernel
TARGET_RECOVERY_INITRC := device/htc/eyeul/recovery/etc/init.rc
...
TARGET_INIT_VENDOR_LIB := libinit_eyeul
TARGET_LIBINIT_DEFINES_FILE := device/htc/eyeul/init/init_eyeul.c
